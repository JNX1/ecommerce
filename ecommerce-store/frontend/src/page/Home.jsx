        ...
        <div className="home">
            <div className="container">
                <div className="row">
                    <div className="col-md-6 col-12 mb-3 mx-auto">
                        <h1>Welcome to <span>JCF Suits</span> </h1>
                        <p>Home of the best suits made with premium materials.</p>

                        {/*FALTA REDIRECIONAR PARA OS PRODUTOS!!! NAO ESQUECER DE FAZER*/}
                        <button className="btn btn-outline">Products</button>

                    </div>
                    <div className="col-md-6 col-12 mb-3 mx-auto">
                        <img src="../img/logo.png" alt="home " className="img-fluid main-img" />
            ...
            <div className="desc">
               ...
               <div className="col-md-6 col-12 mx-auto mb-3 ">
                 //   <img src="../img/logo.png" alt="ok" className="img-fluid side-img" />
                </div>
               
               */}
                    <div className=" col-md-6 col-12 mx-auto mb-3 d-flex justify-content-center align-items-center flex-column">
                    <h1>Welcome to <span>JCF Suits</span> </h1>
                        <p>We pride ourselves in our heritage and values, as well as in our craftsmanship. We sell suits made with the most exclusive and premium materials available. </p>
